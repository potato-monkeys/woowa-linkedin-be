...
-- ---------------- USERS ----------------
INSERT INTO users (id, nickname, password, introduction) VALUES (1, '감자',   'password1', '안녕하세요, 감자입니다.');
INSERT INTO users (id, nickname, password, introduction) VALUES (2, '고구마', 'password2', '달콤한 고구마예요.');
INSERT INTO users (id, nickname, password, introduction) VALUES (3, '당근',   'password3', '건강한 당근입니다.');
INSERT INTO users (id, nickname, password, introduction) VALUES (4, '양파',   'password4', '눈물나는 양파.');
INSERT INTO users (id, nickname, password, introduction) VALUES (5, '마늘',   'password5', '톡 쏘는 마늘.');
INSERT INTO users (id, nickname, password, introduction) VALUES (6, '호박',   'password6', '둥글둥글 호박.');
INSERT INTO users (id, nickname, password, introduction) VALUES (7, '가지',   'password7', '보라보라 가지.');
INSERT INTO users (id, nickname, password, introduction) VALUES (8, '토마토', 'password8', '빨간 토마토입니다.');
